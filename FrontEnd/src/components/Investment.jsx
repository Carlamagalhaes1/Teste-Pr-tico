export default function Investment() {
  return (
    <section className=" p-6 sm:p-4 md:pt-0 md:pb-0 lg:px-[72px] lg:pb-12 lg:pt-8 font-sans">  
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4">      
        ...
        <div className="bg-[#7070702a] p-2  lg:p-6 flex flex-col justify-center items-center rounded-lg border border-[#70707082] text-center">
          ...
          <p className="text-xs leading-snug text-[#1E1E1E]  mt-2">
            Reportagens & Colunistas; <br /> Filmes & Séries; <br /> Podcasts & Web Stories.
          </p>
          <a
            href="#"
            className="mt-3 text-[#1F6482] text-[16px] font-bold hover:underline"
          >
            Conheça o OPOVO+
          </a>
        </div>
